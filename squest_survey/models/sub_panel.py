...
class SubscriptionPanel(models.Model):
    sub_templates = models.ManyToManyField(SubscriptionTemplate, verbose_name=_("Subscription Panel"), related_name='panels')
    ...
    class Meta:
        verbose_name = _("Subscription Panel")
        verbose_name_plural = _("Subscription Panels")
        ordering = ('name',)
    ...
    def save(self, *args, **kwargs):
        ...
        super(SubscriptionPanel, self).save(*args, **kwargs)
